...
detected ASIC's parameter list, and applies any differences through its regular DMS NVConfig batch.
It does not invoke `set_system_conf` during reconciliation.
