...
<em>string</em></td>
<td><em>(Optional)</em>
<p>DocaSpcXCCUrlSource represents a url source for DOCA SPC-X CC .deb package for ubuntu 22.04</p></td>
</tr>
</tbody>
</table></td>
</tr>
...
*Generated with `gen-crd-api-reference-docs` on git commit `d776db5`.*
