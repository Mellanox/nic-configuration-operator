...
func (_m *ConfigurationUtils) GetTrustAndPFC(interfaceName string) (string, string, error) {
...
func (_m *ConfigurationUtils) SetTrustAndPFC(interfaceName string, trust string, pfc string) error {
